  ...
  return (
    <Container>
      <div className="flex items-center justify-between">
        ...
        >
          <Logomark
            className="h-8 block cursor-pointer"
            invert={invert}
            filled={logoHovered}
          /> 
          <Logo
...
function Navigation() {
  return (
    <nav className="mt-px font-display text-5xl font-medium tracking-tight text-white">
      <NavigationRow>
        <NavigationItem href="/concevoir">Concevoir</NavigationItem>
        <NavigationItem href="/processus">Le processus</NavigationItem>
      </NavigationRow>
      <NavigationRow>
        <NavigationItem href="/referencer">Référencer</NavigationItem>
        <NavigationItem href="/a-propos">À propos</NavigationItem>
      </NavigationRow>
      <NavigationRow>
        <NavigationItem href="/convertir">Convertir</NavigationItem>
        <NavigationItem href="/blogue">Blogue</NavigationItem>
      </NavigationRow>
    </nav>
  )
}
...
function RootLayoutInner({ children }) {
  ...
  return (
    ...
    >
      <header>
        {/* Header “de fond” : inaccessible quand le menu est ouvert */}
        <div
        ...
        {/* Panneau du menu : inaccessible quand le menu est fermé */}
        <motion.div
          layout
          id={panelId}
